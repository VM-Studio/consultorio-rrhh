...
export default function Footer() {
  ...
  if (isMobile) {
    return (
      ...
      >
        {/* Logo */}
        <Image src="/motusfooter.png" alt="Motus" width={960} height={432} style={{ width: '320px', height: 'auto', marginBottom: '36px', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
